  ...
  <pre>
{
    ...
    "link": [
        {
            "relation": "self",
            "url": "http://<EDTEUR>/Slot?_include=Slot:schedule&_include:iterate=Schedule:actor&start=ge2024-06-12T16:20:00.000+02:00&start=le2024-06-15T17:20:00.000+02:00&schedule.actor:Practitioner.identifier=urn:oid:1.2.250.1.71.4.2.1|810002909371&status=free&_include=Slot:service-type-reference&__include:iterate=HealthcareService:organization&_count=1000"
        }
    ],
    "entry": [
        {
            "fullUrl": "https://<EDITEUR>/Practitioner/cd04a68c-1d0b-40b2-bd7f-a8de60b9961c",
            "resource": {
                "id": "cd04a68c-1d0b-40b2-bd7f-a8de60b9961c",
        ...
        {
            "fullUrl": "https://<EDITEUR>/PractitionerRole/22131415-815c-41b3-8b4b-3722b6f3be4f",
            "resource": {
                "id": "22131415-815c-41b3-8b4b-3722b6f3be4f",
                ...
                "practitioner": {
                    "reference": "Practitioner/cd04a68c-1d0b-40b2-bd7f-a8de60b9961c"
                },
                "organization": {
                    "identifier": {
        ...
        {
            "fullUrl": "https://<EDITEUR>/Schedule/5aaebaf5-f130-4111-98c9-0fb80f3c1b00",
            "resource": {
                "id": "5aaebaf5-f130-4111-98c9-0fb80f3c1b00",
                ...
                "actor": [
                    ...
                    {
                        "reference": "PractitionerRole/22131415-815c-41b3-8b4b-3722b6f3be4f"
                    }
                ]
            }
        },
        {
            "fullUrl": "https://<EDITEUR>/Slot/232198ad-d733-4aa7-ac43-d8810b19750f",
            "resource": {
                "id": "232198ad-d733-4aa7-ac43-d8810b19750f",
                "resourceType": "Slot",
                "status": "free",
                "start": "2024-06-12T16:40:00.000+02:00",
                "end": "2024-06-12T17:00:00.000+02:00",
                "comment": "http://<EDITEUR>/Slot/232198ad-d733-4aa7-ac43-d8810b19750f",
                "meta": {
                    "profile": [
                        "https://interop.esante.gouv.fr/ig/fhir/sas/StructureDefinition/sas-cpts-slot-aggregator"
                    ],
                ...
                "schedule": {
                    "reference": "Schedule/5aaebaf5-f130-4111-98c9-0fb80f3c1b00"
                }
            }
        },
        {
            "fullUrl": "https://<EDITEUR>/HealthcareService/e9e31708-9550-4197-8c32-ae541b6a5cbd",
            "resource": {
                "id": "e9e31708-9550-4197-8c32-ae541b6a5cbd",
                ...
                "providedBy": {
                    "reference": "Organization/0ed28098-f58f-44ff-a60c-615827e4241f"
                }
            }
        },
        {
            "fullUrl": "https://<EDITEUR>/Organization/0ed28098-f58f-44ff-a60c-615827e4241f",
            "resource": {
                "id": "0ed28098-f58f-44ff-a60c-615827e4241f",
