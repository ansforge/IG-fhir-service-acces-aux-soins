...
Parent: Bundle
Id: BundleAgregateur
Description: "Profil de Bundle qui représente le flux de réponse contenant les créneaux disponibles dans le cadre du service d'aggrégation de créneaux de la plateforeme SAS (Service d'accès aux soins)"
