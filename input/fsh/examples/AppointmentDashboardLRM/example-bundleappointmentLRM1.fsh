...
* entry[appointmententry].fullUrl = "https://<base_URl>/Slot/ExampleAppointmentLRM1"

* entry[practitionerentry].resource = ExamplePractitionerLRM
* entry[practitionerentry].fullUrl = "https://<base_URl>/Schedule/ExamplePractitionerLRM"

* entry[organizationentry].resource = ExampleSasOrganization
* entry[organizationentry].fullUrl = "https://<base_URl>/Practitioner/ExampleSasOrganization"
