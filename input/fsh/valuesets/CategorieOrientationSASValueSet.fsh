CodeSystem: CategorieOrientationSASValueSet
Id:         categorie-orientation-sas-valueset
Title:     "Value set catégorie orientation SAS"
Description: "Valueset permettant de définir la catégorie d'orientation SAS. Il regroupe des codes de la TRE-R66 et du codesystem catégorie d'orientation SAS"
