# Profil SAS consommateur de créneaux CPTS - Service d'Accès aux Soins v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/sas/CapabilityStatement/SAS-Consommateur-CPTS | *Version*:1.1.0 |
