# PS à titre individuel - Service d'Accès aux Soins v1.2.0
...
| [sas-valueset-appointment-status](ValueSet-sas-valueset-appointment-status.md) | ValueSet | Etat du RDV SAS |
