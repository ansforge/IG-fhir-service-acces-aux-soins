...
## Exemple Slot: ExampleSlotPSIndiv2
...
Label de sécurité: [Créneau accessible par l'ensemble des professionnels de santé (Détails : code TRE_R314_TypeCreneau PRO = 'Créneau accessible par l'ensemble des professionnels de santé')](https://smt.esante.gouv.fr/fhir/ValueSet/TRE-R314-TypeCreneau)
