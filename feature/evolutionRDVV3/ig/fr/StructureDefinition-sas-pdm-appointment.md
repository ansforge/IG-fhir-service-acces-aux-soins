...
## Profil de ressource: FrAppointmentSASPDM 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.sas|current/StructureDefinition/sas-pdm-appointment)
...
Autres représentations du profil : [CSV](../StructureDefinition-sas-pdm-appointment.csv), [Excel](../StructureDefinition-sas-pdm-appointment.xlsx), [Schematron](../StructureDefinition-sas-pdm-appointment.sch) 
