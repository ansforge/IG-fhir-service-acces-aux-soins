# FrAppointmentSASPDM - Service d'Accès aux Soins v1.2.0

## Resource Profile: FrAppointmentSASPDM 

 
Profil de Slot, dérivé de FrSlot, pour le service d’agrégation de créneaux de la plateforme SAS - cas d’usage Place de Marché 

**Usages:**

* This Profile is not used by any profiles in this Specification

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.sas|current/StructureDefinition/StructureDefinition-sas-pdm-appointment.json)
...
Other representations of profile: [CSV](../StructureDefinition-sas-pdm-appointment.csv), [Excel](../StructureDefinition-sas-pdm-appointment.xlsx), [Schematron](../StructureDefinition-sas-pdm-appointment.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/sas/StructureDefinition/sas-pdm-appointment",
  "version" : "1.2.0",
