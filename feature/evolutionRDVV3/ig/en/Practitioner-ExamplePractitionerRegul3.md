# ExamplePractitionerRegul3 - Service d'Accès aux Soins v1.2.0

## Example Practitioner: ExamplePractitionerRegul3
...
Profile: [FrPractitionerRegul](StructureDefinition-FrPractitionerRegul.md)
