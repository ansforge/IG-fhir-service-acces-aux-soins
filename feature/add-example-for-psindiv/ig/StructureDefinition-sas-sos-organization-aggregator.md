...
| Active as of 2026-01-06 | *Computable Name*:FrOrganizationAgregateurSOS |
...
* Référer à ce Profil: [FrLocationAgregateurSOS](StructureDefinition-sas-sos-location-aggregator.md)
* Exemples pour ce Profil: [SOS Médecins de Rennes](Organization-ExampleOrgaSOS1.md) and [SOS Médecins Lorient et agglomération](Organization-ExampleOrgaSOS2.md)
