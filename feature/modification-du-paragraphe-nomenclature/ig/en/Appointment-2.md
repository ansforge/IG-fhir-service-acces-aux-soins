# ExampleAppointmentCancelled - Service d'Accès aux Soins v1.2.0

## Example Appointment: ExampleAppointmentCancelled
...
Profile: [FrAppointmentSAS](StructureDefinition-FrAppointmentSAS.md)
