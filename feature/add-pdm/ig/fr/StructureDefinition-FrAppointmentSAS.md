...
* CapabilityStatements utilisant ce Profil: [Profil SAS gestionnaire d'agenda RDV ps indiv](CapabilityStatement-SAS-GestionnaireAgenda-RDVpsindiv.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.sas|current/StructureDefinition/FrAppointmentSAS)
...
Autres représentations du profil : [CSV](../StructureDefinition-FrAppointmentSAS.csv), [Excel](../StructureDefinition-FrAppointmentSAS.xlsx), [Schematron](../StructureDefinition-FrAppointmentSAS.sch) 
