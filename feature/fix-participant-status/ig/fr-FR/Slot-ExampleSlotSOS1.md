...
##  Slot: ExampleSlotSOS1

Profil: [FrSlotAgregateurSOS](StructureDefinition-sas-sos-slot-aggregator.md)

Label de sécurités: [Créneau public (Détails : code TRE_R314_TypeCreneau PUBLIC = 'Créneau public')](https://smt.esante.gouv.fr/fhir/ValueSet/TRE-R314-TypeCreneau), [Créneau soins non programmé (Détails : code TRE_R314_TypeCreneau SNP = 'Créneau soins non programmé')](https://smt.esante.gouv.fr/fhir/ValueSet/TRE-R314-TypeCreneau)
