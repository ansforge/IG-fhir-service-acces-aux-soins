...
##  Slot: ExampleSlotPSIndiv5

Profil: [FrSlotAgregateur](StructureDefinition-FrSlotAgregateur.md)

Label de sécurité: [Créneau professionnel (Détails : code TRE_R314_TypeCreneau PRO = 'Créneau professionnel')](https://smt.esante.gouv.fr/fhir/ValueSet/TRE-R314-TypeCreneau)
