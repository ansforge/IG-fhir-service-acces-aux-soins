...
Profile: [FrSlotAgregateurSOS](StructureDefinition-sas-sos-slot-aggregator.md)

Security Label: [Créneau accessible par le grand public (Details: TRE_R314_TypeCreneau code PUBLIC = 'Créneau accessible par le grand public')](https://smt.esante.gouv.fr/fhir/ValueSet/TRE-R314-TypeCreneau)
