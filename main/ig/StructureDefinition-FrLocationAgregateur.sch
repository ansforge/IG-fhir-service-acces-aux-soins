...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile FrLocation
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Location">
      <sch:assert test="count(f:extension[@url = 'http://interopsante.org/fhir/StructureDefinition/FrLocationUsePeriod']) &lt;= 1">extension with URL = 'http://interopsante.org/fhir/StructureDefinition/FrLocationUsePeriod': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Location/f:partOf">
      <sch:assert test="count(f:extension[@url = 'http://interopsante.org/fhir/StructureDefinition/FrLocationPartOfPositionRoom']) &lt;= 1">extension with URL = 'http://interopsante.org/fhir/StructureDefinition/FrLocationPartOfPositionRoom': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
