...
##  Slot: ExampleSlotPSIndiv1

Profil: [FrSlotAgregateur](StructureDefinition-FrSlotAgregateur.md)

Label de sécurité: [Créneau public (Détails : code TRE_R314_TypeCreneau PUBLIC = 'Créneau public')](https://smt.esante.gouv.fr/fhir/ValueSet/TRE-R314-TypeCreneau)

**serviceType**: ambulatory, virtual, Visite de contrôle

**specialty**: Médecine générale, Chirurgie générale
