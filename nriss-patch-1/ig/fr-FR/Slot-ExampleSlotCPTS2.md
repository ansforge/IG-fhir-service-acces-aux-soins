...
##  Slot: ExampleSlotCPTS2

Profil: [FrSlotAgregateurCPTS](StructureDefinition-sas-cpts-slot-aggregator.md)

Label de sécurités: [Créneau public (Détails : code TRE_R314_TypeCreneau PUBLIC = 'Créneau public')](https://smt.esante.gouv.fr/fhir/ValueSet/TRE-R314-TypeCreneau), [Créneau de structure CPTS (Détails : code TRE_R314_TypeCreneau CPTS = 'Créneau de structure CPTS')](https://smt.esante.gouv.fr/fhir/ValueSet/TRE-R314-TypeCreneau)
